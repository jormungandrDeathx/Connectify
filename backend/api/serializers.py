...
class UserSerializer(serializers.ModelSerializer):
    ...
    profile_picture = serializers.ImageField(source="profile.profile_picture",required=False, allow_blank=True)
    class Meta:
        model = User
    ...
    def update(self, instance, validated_data):
        ...
        new_upload = profile_data.get("profile_picture")
        ...
        remove_flag = request.data.get("profile_picture")==""
        
        if request and remove_flag:
            if profile.profile_picture and profile.profile_picture.name!=settings.DEFAULT_AVATAR:
                profile.profile_picture.delete(save=False)
